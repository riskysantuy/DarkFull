...
# Coded By. Risky-Santuy
# Mau Recode? Bangsat Kau Takada Modal
...
sleep 3
echo $i"[][][][][][][][][][][][][][][][][][][][][]"
echo $i"[] SILAHKAN TUNGGU TOOLS DARKFBFULL WORK[]"
echo $i"[][][][][][][][][][][][][][][][][][][][][]"
echo
sleep 3
echo $cy"============================================"
...
*) echo "KONTOL!!!! Yang Anda Cari Ga ADa!"
esac